...
## [10.0.0](https://github.com/localnerve/nodemailer/compare/v9.0.1...v10.0.0) (2026-06-29)
...
* absorb TLS errors during socket teardown ([7f8dde4](https://github.com/localnerve/nodemailer/commit/7f8dde41438c66b8311e888fa5f8c518fcaba6f1))
* absorb TLS errors during socket teardown ([381f628](https://github.com/localnerve/nodemailer/commit/381f628d55e62bb3131bd2a452fa1ce00bc48aea))
* add connection fallback to alternative DNS addresses ([e726d6f](https://github.com/localnerve/nodemailer/commit/e726d6f44aa7ca14e943d4303243cb5494b09c75))
* Add Gmail Workspace service configuration ([#1787](https://github.com/localnerve/nodemailer/issues/1787)) ([dc97ede](https://github.com/localnerve/nodemailer/commit/dc97ede417b3030b311771541b1f17f5ca76bcbf))
* added support for REQUIRETLS ([#1793](https://github.com/localnerve/nodemailer/issues/1793)) ([053ce6a](https://github.com/localnerve/nodemailer/commit/053ce6a772a7c608e6bee7f58ebe9900afbd9b84))
...
* **addressparser:** Fixed addressparser handling of quoted nested email addresses ([1150d99](https://github.com/localnerve/nodemailer/commit/1150d99fba77280df2cfb1885c43df23109a8626))
* **addressparser:** flatten nested groups per RFC 5322 ([8f8a77c](https://github.com/localnerve/nodemailer/commit/8f8a77c67f0ba94ddf4e16c68f604a5920fb5d26))
* **addressparser:** keep operator chars inside an address-literal as text ([#1829](https://github.com/localnerve/nodemailer/issues/1829)) ([9ba1064](https://github.com/localnerve/nodemailer/commit/9ba1064f3b115cd60cb63aa954a3c0961e86fbb7))
...
* apply the transport-level newline option in stream and sendmail transports ([cb4f904](https://github.com/localnerve/nodemailer/commit/cb4f904a53d2c2feeaf327203c92378d46304398))
...
* centralize and standardize error codes ([45062ce](https://github.com/localnerve/nodemailer/commit/45062ce7a4705f3e63c5d9e606547f4d99fd29b5))
* clean up addressparser and fix group name fallback producing undefined ([9d55877](https://github.com/localnerve/nodemailer/commit/9d55877f8ed15a6aefd7ba76cbb6b6a6cdbcc4fd))
...
* decode SMTP server responses as UTF-8 at line boundary ([95876b1](https://github.com/localnerve/nodemailer/commit/95876b103e587e49583e43f88cb2c3a61556f3ac))
* **dns:** add memory leak prevention for DNS cache ([0240d67](https://github.com/localnerve/nodemailer/commit/0240d6795ded6d8008d102161a729f120b6d786a))
* downgrade transient connection error logs to warn level ([4c041db](https://github.com/localnerve/nodemailer/commit/4c041db85d560e98bc5e1fd5d5a191835c5b7d2f))
...
* enforce disableFileAccess/disableUrlAccess for raw message option ([a82e060](https://github.com/localnerve/nodemailer/commit/a82e060d978f27e5f41369a9a9807b1e3dedc2e2))
* enforce strict TLS for OAuth2 and Ethereal credential requests ([#1818](https://github.com/localnerve/nodemailer/issues/1818)) ([833d6e5](https://github.com/localnerve/nodemailer/commit/833d6e58c8b717962bbb1b23e16923cd267c3bc9))
* fall back to lower-severity handler when custom logger lacks a level method ([6d849df](https://github.com/localnerve/nodemailer/commit/6d849df59a56184b48844ed10b5fb7b8e9f74634))
* fix cookie bugs, remove dead code, and improve hot-path efficiency ([e8c8b92](https://github.com/localnerve/nodemailer/commit/e8c8b92f46f2a82d06d49cc9a6ffc26067f68524))
...
* four listener/stream leaks in SMTP transport, connection, pool ([#1817](https://github.com/localnerve/nodemailer/issues/1817)) ([850bb91](https://github.com/localnerve/nodemailer/commit/850bb91bff7707ed498c1424df01c4e5b30ea14b))
...
* harden DNS fallback against race conditions and cleanup issues ([4fa3c63](https://github.com/localnerve/nodemailer/commit/4fa3c63a1f36aefdbaea7f57a133adc458413a47))
* harden smtp-connection low-severity issues ([22ddcea](https://github.com/localnerve/nodemailer/commit/22ddcea8ed043e4ea23b8971b75a2df196b5a581))
* harden smtp-connection response parsing and socket lifecycle ([68860b9](https://github.com/localnerve/nodemailer/commit/68860b94311b5b6837754e5e790f186ca8a00b70))
...
* improve socket cleanup to prevent potential memory leaks ([6069fdc](https://github.com/localnerve/nodemailer/commit/6069fdcff68a3eef9a9bb16b2bf5ddb924c02091))
* include icalEvent path/href content in the application/ics attachment ([b801c48](https://github.com/localnerve/nodemailer/commit/b801c48fab8e9b71bc7e0ea1fb32ce6b34675b15))
* Increase data URI size limit from 100KB to 50MB and preserve content type ([28dbf3f](https://github.com/localnerve/nodemailer/commit/28dbf3fe129653f5756c150a98dc40593bfb2cfe))
...
* keep domain as UTF-8 when local part is non-ASCII ([#1814](https://github.com/localnerve/nodemailer/issues/1814)) ([66d4ecb](https://github.com/localnerve/nodemailer/commit/66d4ecb5aa431f3614a26b3c08b9c63cdf32a9ea))
* **legacy:** Removed post-install script (not used anymore) and CONTRIBUTIONS.md (leftover from OpenCollective) ([13672b2](https://github.com/localnerve/nodemailer/commit/13672b231384d360a1a70f902c6888140f138975))
...
* **linter:** Updated eslint and created prettier formatting task ([df13b74](https://github.com/localnerve/nodemailer/commit/df13b7487e368acded35e45d0887d23c89c9177a))
* merge fragmented display names with unquoted commas in addressparser ([fe27f7f](https://github.com/localnerve/nodemailer/commit/fe27f7fd57f7587d897274438da2f628ad0ad7d9))
...
* **mime:** Added GeoJSON closes [#1637](https://github.com/localnerve/nodemailer/issues/1637) ([#1665](https://github.com/localnerve/nodemailer/issues/1665)) ([79b8293](https://github.com/localnerve/nodemailer/commit/79b8293ad557d36f066b4675e649dd80362fd45b))
* parse Ethereal response props without polynomial regex backtracking ([067aebe](https://github.com/localnerve/nodemailer/commit/067aebec83b8cbe7682905e89b30ab19d260b503))
...
* prevent SES transport callback double-invocation and hang on sync errors ([#1831](https://github.com/localnerve/nodemailer/issues/1831)) ([9517bc5](https://github.com/localnerve/nodemailer/commit/9517bc5dc94e77907bb157e3466bf73a2b327f5c))
* prevent stack overflow DoS in addressparser with deeply nested groups ([b61b9c0](https://github.com/localnerve/nodemailer/commit/b61b9c0cfd682b6f647754ca338373b68336a150))
...
* refactor smtp-connection for clarity and add Node.js 6 syntax compat test ([c5b48ea](https://github.com/localnerve/nodemailer/commit/c5b48ea61c28eabf347972f4198a12cdab226ff7))
* refresh expired DNS cache on error ([#1759](https://github.com/localnerve/nodemailer/issues/1759)) ([ea0fc5a](https://github.com/localnerve/nodemailer/commit/ea0fc5a6633a3546f4b00fcf2f428e9ca732cdb6))
* reject CRLF in HTTP proxy CONNECT destination to prevent request injection ([6347b47](https://github.com/localnerve/nodemailer/commit/6347b47c7d12f9d3acf53d391b921e836f400640))
* **release:** Trying to fix release proecess by upgrading Node version in runner ([579fce4](https://github.com/localnerve/nodemailer/commit/579fce4683eb588891613a6c9a00d8092e8c62d1))
* remove familySupportCache that broke DNS resolution tests ([c803d90](https://github.com/localnerve/nodemailer/commit/c803d901f195a21edbb2c276b2e116564467aaaa))
* replace deprecated url.parse with a WHATWG URL wrapper ([0c080fb](https://github.com/localnerve/nodemailer/commit/0c080fbf3278926f013a5c2ad06f5f6f0e18f5ed))
* resolve linter errors in DNS cache tests ([3b8982c](https://github.com/localnerve/nodemailer/commit/3b8982c1f24508089a8757b74039000a4498b158))
* resolve oauth2_provision_cb at send time for non-pooled SMTP transports ([203c8ec](https://github.com/localnerve/nodemailer/commit/203c8ecf97594ac2e69919b0f3ba966c0f86750e))
* restore base64 wrap() trim behavior to prevent trailing CRLF ([#1810](https://github.com/localnerve/nodemailer/issues/1810)) ([#1811](https://github.com/localnerve/nodemailer/issues/1811)) ([b1ae6c1](https://github.com/localnerve/nodemailer/commit/b1ae6c1c2927240737d9f68f316f0c84042b8adb))
* return the promise from every resolveContent branch ([07ffe8c](https://github.com/localnerve/nodemailer/commit/07ffe8cfd97f0486b8c7b541f398922ddab47882))
* sanitize CRLF in transport name option to prevent SMTP command injection (GHSA-vvjj-xcjg-gr5g) ([0a43876](https://github.com/localnerve/nodemailer/commit/0a43876801a420ca528f492eaa01bfc421cc306e))
* sanitize envelope size to prevent SMTP command injection ([2d7b971](https://github.com/localnerve/nodemailer/commit/2d7b9710e63555a1eb13d721296c51186d4b5651))
...
* strip the url scheme from List-ID header values ([77e5885](https://github.com/localnerve/nodemailer/commit/77e5885cfa0c6723ea7749c1ee74b1c11aeb78bd))
* tag AWS SES transport errors with the ESES code ([efa647a](https://github.com/localnerve/nodemailer/commit/efa647a125dd698413a7cf6813b8e36881a06f91))
...
* two pending security advisories (jsonTransport access bypass, List-* CRLF injection) ([#1820](https://github.com/localnerve/nodemailer/issues/1820)) ([5f69497](https://github.com/localnerve/nodemailer/commit/5f694977da2e0e13dc947037566e8e689a01217e))
...
* use 8bit encoding for message/rfc822 attachments ([adf8611](https://github.com/localnerve/nodemailer/commit/adf86113217b23ff3cd1191af5cd1d360fcc313b))
* validate TLS certificates by default when fetching remote content ([6a947ac](https://github.com/localnerve/nodemailer/commit/6a947ac7114a16da1e6a50d9a6f4e17026ce145d))
